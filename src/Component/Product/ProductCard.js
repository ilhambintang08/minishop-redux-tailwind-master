...
const ProductCard = (props) => {
    return (
        <div
            className='border border-solid border-slate-400 p-4 rounded-md text-center'>
            <img
            ...
            <Link
                ...
                className='px-6 py-3 bg-green-500 border-0 text-white mt-8 block'>Go To Product</Link>
        </div>
    )
}
